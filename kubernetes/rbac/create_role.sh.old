...
Options:
  --role-name=STRING         Name of ClusterRole to create
                               (default=\"couchbase-operator\", environment variable: ROLE_NAME)
  --role-binding-name=STRING Name of ClusterRoleBinding to create
                               (default=\"couchbase-operator\", environment variable: ROLE_BINDING_NAME)
...
ROLE_NAME="${ROLE_NAME:-couchbase-operator}"
ROLE_BINDING_NAME="${ROLE_BINDING_NAME:-couchbase-operator}"
